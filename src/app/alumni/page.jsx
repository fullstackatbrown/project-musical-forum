  ...
  return (
    <div className="min-h-screen bg-[#f3e1f6] pb-8">
      ...
      <div className="w-full bg-[#e75480] py-4 mt-20">
        <h1 className="text-white text-4xl font-bold text-center m-0">
          PLAYBILL
        </h1>
      </div>
      ...
      <main className="max-w-3xl mx-auto mt-16 text-center px-4">
        ...
        <h2 className="text-xl font-normal mb-12 text-black">
        ...
        <div className="my-8 text-left">
          {alumni.map((alum, index) => (
            <div key={index} className="flex items-baseline mb-6 text-xl">
              <span className="text-[#e75480] font-bold whitespace-nowrap">
                {alum.name}
              </span>
              <span className="flex-1 mx-2 text-[#e75480] overflow-hidden whitespace-nowrap">
                {".".repeat(100)}
              </span>
              <span className="text-[#e75480] whitespace-nowrap">
                '{alum.year}
              </span>
            </div>
          ))}
